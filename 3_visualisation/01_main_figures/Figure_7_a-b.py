...
and saves the clustermap plots to the configured output directory.
...
FEATURE_TYPE_PALETTE = {
    ...
    "Molecular": COLORS.get('Metabolite', 'lightcoral'),
...
def load_combined_shap_data(pairing: str, shap_data_dir: str, target_cols: list) -> pd.DataFrame | None:
    ...
    for task_name in target_cols:
        # Map 'Time Point' to 'Day' for filename compatibility
        ...
        if os.path.exists(csv_filepath):
            ...
            try:
                ...
                # Standardize 'Metabolite' feature type to 'Molecular'
...
def plot_shap_clustermap(shap_data: pd.DataFrame, pairing: str, config: dict):
    ...
    palette = config['FEATURE_TYPE_PALETTE']
    ...
    try:
        ...
        row_colors_series.name = 'Feature Type'
