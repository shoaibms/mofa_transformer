# -*- coding: utf-8 -*-
"""
generate_hyperseq_figures_3.py

This script generates the 6-panel validation figure for HyperSeq analysis.
It processes MOFA+ results, transformer attention scores, and permutation test results.
"""
import pandas as pd
import numpy as np
import os
...
print("="*80)
print("HyperSeq Figure Generation")
print("="*80)
...
PERMUTATION_RESULTS_PATH = os.path.join(BASE_DIR, "transformer_results", "results", "permutation_test_results_HyperSeq.json")
...
def create_figure(data, output_dir, font_sizes):
    """Creates the validation figure."""
    print("\n3. Generating validation figure...")
    ...
    # Using Factor 3 (integration factor)
...
if __name__ == "__main__":
    print("\n1. Loading necessary result files...")
    all_data = load_all_data()
    
    if all_data:
        print("\n2. Proceeding with figure generation...")
        create_figure(all_data, FIGURE_OUTPUT_DIR, FONT_SIZES)
        
    else:
        print("\nError: Could not load all necessary data.")
